...
STREAM=${STREAM:-1}
STAMPS=${STAMPS:-0}
FITJSON=${FITJSON:-0}   # 1 = dump per-unit fit JSON (raw mf_snr, for FP calibration)
...
SR=$SR CFG=$CFG STREAM=$STREAM STAMPS=$STAMPS FITJSON=$FITJSON STAMP_SIZE=$STAMP_SIZE \
